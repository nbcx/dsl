...
var file_connection_protobuf_proto_rawDesc = []byte{
	...
	,
...
var file_connection_protobuf_proto_depIdxs = []int32{
	0, // 0: protobuf.Connection.Offline:input_type -> protobuf.ConnectionReq
	0, // 1: protobuf.Connection.Info:input_type -> protobuf.ConnectionReq
	1, // 2: protobuf.Connection.Offline:output_type -> protobuf.ConnectionRsp
	1, // 3: protobuf.Connection.Info:output_type -> protobuf.ConnectionRsp
...
func (c *connectionClient) Offline(ctx context.Context, in *ConnectionReq, opts ...grpc.CallOption) (*ConnectionRsp, error) {
	out := new(ConnectionRsp)
	err := c.cc.Invoke(ctx, "/protobuf.Connection/Offline", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectionClient) Info(ctx context.Context, in *ConnectionReq, opts ...grpc.CallOption) (*ConnectionRsp, error) {
	out := new(ConnectionRsp)
	err := c.cc.Invoke(ctx, "/protobuf.Connection/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedConnectionServer) Offline(context.Context, *ConnectionReq) (*ConnectionRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Offline not implemented")
}
func (*UnimplementedConnectionServer) Info(context.Context, *ConnectionReq) (*ConnectionRsp, error) {
...
func _Connection_Offline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConnectionReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConnectionServer).Offline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.Connection/Offline",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConnectionServer).Offline(ctx, req.(*ConnectionReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Connection_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConnectionReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConnectionServer).Info(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.Connection/Info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConnectionServer).Info(ctx, req.(*ConnectionReq))
	}
	return interceptor(ctx, in, info, handler)
}

var _Connection_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protobuf.Connection",
	HandlerType: (*ConnectionServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Offline",
			Handler:    _Connection_Offline_Handler,
		},
		{
			MethodName: "Info",
			Handler:    _Connection_Info_Handler,
		},
	},
